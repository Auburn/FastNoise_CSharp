...
I have now also created [FastNoise SIMD](https://github.com/Auburns/FastNoiseSIMD), which utilises SIMD CPU instructions to gain huge performance boosts. It is slightly less flexible and cannot be converted to other languages, but if you can I would highly suggest using this for heavy noise generation loads. (This can be used in C# but only through an native C lib linked into C# using extern functions)
...
Download links can be found in the [FastNoise Releases Section](https://github.com/Auburns/FastNoise/releases).
